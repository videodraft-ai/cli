...
describe("specialized video edit commands", () => {
  ...
  it("rejects a creative video reference alongside the edit source, which Google refuses", async () => {
    await expect(
      runEdit([
        "edit",
        "video",
      ...
      exitCode: 2,
      message: expect.stringContaining("exactly one input video"),
    });
  ...
  it("rejects creative reference videos alongside a Gemini Omni 1.1 edit source", async () => {
    await expect(
      runGenerate([
        "generate",
        "video",
  ...
  it("rejects creative reference videos alongside a Gemini Omni 1.1 continuation", async () => {
    await expect(
      runGenerate([
        "generate",
        "video",
