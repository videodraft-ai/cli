...
// "not_started" means no export row exists for this reference — no amount of
// polling can turn that into a finished render, so it is terminal too.
const EXPORT_TERMINAL = new Set(["finished", "failed", "not_started"]);
