...
function writeSkillFiles(files: Record<string, string>, destRoot: string): void {
...
export function registerSkillCommands(program: Command): void {
  ...
  skills
    ...
    .description("Print the skill, or a section: skill | editor | examples | models | pipeline")
  ...
  skills
    .command("path")
    .description("Print the bundled skill's on-disk location (npm install; not the compiled binary)")
    .action(async function (this: Command) {
      const ctx = buildContext(this);
